(() => {
  ...
  const navByRole = {
    ...
    instructor: [["home","Home"],["family","Family Space"],["courses","Courses"],["templates","Course Library"],["abetHub","ABET Hub"],["marketplace","Department Library"],["notebooks","Notebooks"],["calendar","Calendar"],["sportsHub","Sports Hub"],["entertainment","Entertainment"],["help","How to Use"],["chat","Messages"],["settings","My Space"]],
    chair: [["home","Home"],["family","Family Space"],["courses","Courses"],["templates","Course Library"],["people","People & Roles"],["abetHub","ABET Hub"],["marketplace","Department Library"],["notebooks","Notebooks"],["calendar","Calendar"],["sportsHub","Sports Hub"],["entertainment","Entertainment"],["help","How to Use"],["chat","Messages"],["settings","My Space"]],
    assistant_dean: [["home","Home"],["family","Family Space"],["courses","Courses"],["templates","Course Library"],["people","People & Roles"],["abetHub","ABET Hub"],["marketplace","Department Library"],["notebooks","Notebooks"],["calendar","Calendar"],["sportsHub","Sports Hub"],["entertainment","Entertainment"],["help","How to Use"],["chat","Messages"],["settings","My Space"]],
    admin: [["home","Home"],["family","Family Space"],["courses","Courses"],["templates","Course Library"],["people","People & Roles"],["abetHub","ABET Hub"],["marketplace","Department Library"],["notebooks","Notebooks"],["calendar","Calendar"],["sportsHub","Sports Hub"],["entertainment","Entertainment"],["help","How to Use"],["chat","Messages"],["settings","My Space"]],
  };
  const esc = (s) =>
    String(s ?? "").replace(
      /[&<>'"]/g,
  ...
  window.addEventListener("message", event => {
    ...
    if (event.data?.type === "prohub-navigate") {
      activeView = event.data.view || "home";
      renderShell();
    }
  });
  ...
  async function renderView() {
    ...
    try {
      ...
      if (activeView === "abetHub") await abetHub(v);
  ...
  async function abetHub(v) {
    if (!isFacultyRole()) {
      v.innerHTML = `<div class="error">ABET Hub is available to faculty and leadership accounts.</div>`;
      return;
    }
    v.innerHTML = `
      <div class="abet-integration-shell">
        <div class="abet-integration-toolbar">
          <div>
            <b>OSUIT ETDE ABET Unified Hub</b>
            <div class="muted">Program objectives, SLO mapping, evidence, annual review, personnel, and continuous improvement</div>
          </div>
          <div class="actions">
            <button class="btn ghost" id="reloadAbetHub" type="button">Reload ABET Hub</button>
            <a class="btn ghost" href="./abet-hub/index.html" target="_blank" rel="noopener">Open full screen</a>
          </div>
        </div>
        <iframe id="abetHubFrame" class="abet-hub-frame" src="./abet-hub/index.html?embedded=1" title="OSUIT ETDE ABET Unified Hub"></iframe>
      </div>`;
    document.getElementById("reloadAbetHub").onclick = () => {
      const frame = document.getElementById("abetHubFrame");
      frame.src = `./abet-hub/index.html?embedded=1&_=${Date.now()}`;
    };
  }
